...
public class GuavaContainerFactory implements InternalContainerFactoryProvider {
    ...
    private static Map<Class<?>, Function<?, ?>> getContainerFactoryFunctions() {
        ...
        map.put(ImmutableMap.class, (Function<Map<?, ?>, ImmutableMap<?, ?>>) map1 -> ImmutableMap.copyOf(map1));
    ...
    public <T, R> Function<T, R> createFromOtherFunction(Class<R> type, List<Class<?>> typeArguments) {
